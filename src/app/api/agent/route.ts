...
//       }
//       selectedModel = (proj.model === 'claude-sonnet-4.5' ? 'claude-sonnet-4.5' : 'gpt-4.1');
//     }
...
//       if (!apiKey) {
//         return new Response(JSON.stringify({ error: 'Missing Anthropic API key' }), { status: 400, headers: { 'Content-Type': 'application/json' } });
//       }
