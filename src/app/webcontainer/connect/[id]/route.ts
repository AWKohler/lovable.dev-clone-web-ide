...
export async function GET(
  ...
  const editorOrigin = searchParams.get('editorOrigin') || request.headers.get('origin') || 'http://localhost:3000';
...
<html lang="en">
  ...
  return new Response(htmlContent, {
    headers: {
      ...
      // WebContainer required headers - these might interfere, let's try without them first
